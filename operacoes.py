...
#agrupar por nome e contar o número de casos em cada um
cases_by_name = df.groupby('Nome do Advogado Principal').size().reset_index(name='Número de Casos')

#criar uma lista com somente os nomes dos advogados que possuem mais de 10 casos
cases_choices = []
...
for nm in cases_choices:
    ...
    #print das informações escolhidas como mais importante(Ações e Cnpj) de cada um dos advogados com mais casos de forma organizada
    print(f"\n{nm.upper()} \n\nAções: \n{actions}\n\nCNPJ: \n{cnpj}")
